...
func main() {
	...
	r.HandleFunc("GET", "/", net.LogHandler(net.RecoverHandler(func(c *net.Context) {
	...
	r.HandleFunc("GET", "/users/:user_id", net.LogHandler(net.RecoverHandler(func(c *net.Context) {
